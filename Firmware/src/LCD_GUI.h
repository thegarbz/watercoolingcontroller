...
void GUI_DisNum_Deci(POINT Xpoint, POINT Ypoint, int32_t Nummber, sFONT* Font, COLOR Color_Background, COLOR Color_Foreground );
void GUI_DisNum_Deci_Fast(POINT Xpoint, POINT Ypoint, int32_t Nummber, int32_t PrevNumber, sFONT* Font, COLOR Color_Background, COLOR Color_Foreground );
